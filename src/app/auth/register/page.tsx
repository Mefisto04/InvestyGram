    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <Card className="w-[450px]">
        <CardHeader>
          ...
          <CardDescription>
            {userType === "startup" 
              ? `Register as a startup ${step === 1 ? "(Step 1 of 2)" : "(Step 2 of 2)"}` 
          ...
          >
            <form onSubmit={handleSubmit}>
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="socialProof.instagramFollowers">Instagram Followers</Label>
                  <Input
                ...
                <div className="space-y-2">
                  <Label htmlFor="fundingInfo.currentRound">Current Funding Round</Label>
                  <Select 
                    onValueChange={(value) => handleSelectChange("fundingInfo.currentRound", value)}
                ...
                <div className="space-y-2">
                  <Label htmlFor="fundingInfo.amountRaised">Amount Raised</Label>
                  <Input
                ...
                <div className="space-y-2">
                  <Label htmlFor="fundingInfo.targetAmount">Target Amount</Label>
                  <Input
                ...
                <div className="space-y-2">
                  <Label htmlFor="investorPrefs.minInvestment">Minimum Investment</Label>
                  <Input
                ...
                <div className="space-y-2">
                  <Label htmlFor="investorPrefs.maxInvestment">Maximum Investment</Label>
                  <Input
                ...
                <div className="space-y-2">
                  <Label htmlFor="investorPrefs.preferredIndustries">Preferred Industries (comma-separated)</Label>
                  <Input
                    ...
                    onChange={(e) => handleArrayChange("investorPrefs.preferredIndustries", e.target.value)}
                  />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="investorPrefs.preferredStages">Preferred Stages (comma-separated)</Label>
                  <Input
                    ...
                    onChange={(e) => handleArrayChange("investorPrefs.preferredStages", e.target.value)}
                  />
                </div>
              </CardContent>
              <CardFooter className="flex flex-col space-y-4">
                    ...
                    onClick={() => {
                      setFormData({
                        ...
                        pastFunding: [
                          ...
                          { companyName: "", amount: 0, year: new Date().getFullYear() },
                        ],
                      });
                    }}
                  >

          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
            <div className="col-span-2 md:col-span-1">
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-xl font-bold text-foreground">InvestyGram</span>
              </div>
              <p className="text-sm mb-4">Connecting innovative startups with forward-thinking investors through our live funding platform..</p>
